...
export default function DashboardClient({ initialPosts }: { initialPosts: EnrichedPost[] }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 md:gap-8 bg-mobile-background md:bg-transparent">
      {/* Filters */}
